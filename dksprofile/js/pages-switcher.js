var PageTransitions = function(a, e) {
    ...
    function m(e) {
        ...
        var t = a(e);
        t = t[0],
        (t = a(t.parentNode)) && (a("ul.site-main-menu li").removeClass("active"),
        t.addClass("active"))
    }
    function c() {
        ...
        var p = a(".ajax-page-load").each(function() {
            if (p = a(this).attr("href"),
            location.hash == location.hash.split("/")[0] + "/" + p.substr(0, p.length - 5)) {
        ...
        a(document).on("click", ".site-main-menu, #ajax-page-close-button", function(t) {
            ...
            setTimeout(function() {
                a("#page-ajax-loaded.closed").html(""),
                e.hide()
            }, 500),
    ...
    function l(e, t) {
        ...
        case 4:
            ...
            l = "pt-page-moveToBottom";
            break;
        case 5:
            c = "pt-page-moveFromRight pt-page-ontop",
            l = "pt-page-fade";
            break;
        case 6:
            c = "pt-page-moveFromLeft pt-page-ontop",
            l = "pt-page-fade";
            break;
        case 7:
            c = "pt-page-moveFromBottom pt-page-ontop",
            l = "pt-page-fade";
            break;
        case 8:
            c = "pt-page-moveFromTop pt-page-ontop",
            l = "pt-page-fade";
            break;
        case 9:
            c = "pt-page-moveFromRightFade",
            l = "pt-page-moveToLeftFade";
            break;
        case 10:
            c = "pt-page-moveFromLeftFade",
            l = "pt-page-moveToRightFade";
            break;
        case 11:
            c = "pt-page-moveFromBottomFade",
            l = "pt-page-moveToTopFade";
            break;
        case 12:
            c = "pt-page-moveFromTopFade",
            l = "pt-page-moveToBottomFade";
            break;
        case 13:
            c = "pt-page-moveFromRight",
        ...
        case 21:
            ...
            break;
        case 22:
            c = "pt-page-scaleUp pt-page-delay300",
            l = "pt-page-scaleDownUp";
            break;
        case 23:
            c = "pt-page-scaleUp",
            l = "pt-page-moveToLeft pt-page-ontop";
            break;
        case 24:
            c = "pt-page-scaleUp",
            l = "pt-page-moveToRight pt-page-ontop";
            break;
        case 25:
            c = "pt-page-scaleUp",
            l = "pt-page-moveToTop pt-page-ontop";
            break;
        case 26:
            c = "pt-page-scaleUp",
            l = "pt-page-moveToBottom pt-page-ontop";
            break;
        case 27:
        ...
        case 36:
            c = "pt-page-scaleUp",
            l = "pt-page-rotateFall pt-page-ontop";
            break;
        case 37:
        ...
        case 46:
            c = "pt-page-moveFromRightFade",
            l = "pt-page-rotateFoldLeft";
            break;
        case 47:
            c = "pt-page-moveFromLeftFade",
            l = "pt-page-rotateFoldRight";
            break;
        case 48:
            c = "pt-page-moveFromBottomFade",
            l = "pt-page-rotateFoldTop";
            break;
        case 49:
            c = "pt-page-moveFromTopFade",
            l = "pt-page-rotateFoldBottom";
            break;
        case 50:
            c = "pt-page-rotateUnfoldLeft",
            l = "pt-page-moveToRightFade";
            break;
        case 51:
            c = "pt-page-rotateUnfoldRight",
            l = "pt-page-moveToLeftFade";
            break;
        case 52:
            c = "pt-page-rotateUnfoldTop",
            l = "pt-page-moveToBottomFade";
            break;
        case 53:
            c = "pt-page-rotateUnfoldBottom",
            l = "pt-page-moveToTopFade";
            break;
        case 54:
        ...
        case 66:
            ...
            break;
        case 67:
            c = "pt-page-rotateSlideIn",
            l = "pt-page-rotateSlideOut"
        }
    ...
    return {
        init: function(e) {
            ...
            m(n),
            l(n),
            a("body").append('<div id="page-ajax-loaded" class="page-ajax-loaded animated rotateInDownRight"></div>'),
            c()
        }
    }
}(jQuery);
