  ...
  return '<div class="item">'
                     +' <div class="blog-card">'
                      +  '<div class="media-block">'
                       +  ' <a href="blog/blog-post-1.html?pagekey='+project.id+'">'
                        +   ' <img class="post-image img-responsive" src="'+project.blogimg+'" alt="blog-post-1" />'
                         +   '<div class="mask"></div>'
                        ...
                        + ' <ul class="category'
                         ...
                         + '</ul>'
                         + '<a href="blog/blog-post-1.html?pagekey='+project.id+'"><h4 class="blog-item-title">'+project.title+'</h4></a>'
                        +'</div>'
                      +'</div>'
                    +'</div>'
                     ...
                     +' <div class="blog-card col-sm-12 col-md-7">'
                      +  '<div class="media-block">'
                       +  ' <a href="projects/project.html?pagekey='+prjct.id+'">'
                        +   ' <img class="post-image img-responsive" src="'+prjct.prjctimg+'" alt="blog-post-1" />'
                         +   '<div class="mask"></div>'
