...
if(isset($_POST['submit'])){
	...
	exit();
	 ...
	 move_uploaded_file($image_tmp,"images/$post_image");
	  ...
	  $insert_query = "insert into cmsposts (post_title,post_date,post_author,post_image,post_keywords,post_content) values ('$post_title','$post_date','$post_author','$post_image','$post_keywords','$post_content')";
...
<div>
	...
	$query = "select * from cmsposts order by 1 DESC LIMIT 0,10";
