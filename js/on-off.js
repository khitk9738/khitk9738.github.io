...
$("#posture_button").on('click', function() {
  document.location.href = "../posture/src/popup.html";
});
...
$("#mood_button").on('click', function() {
  var e=(window.screen.availHeight-200)/2,n=(window.screen.availWidth-650)/2;window.open(chrome.extension.getURL("http://localhost:3000"),"moodplayer","width=850,height=800,top="+e+",left="+n)
});
$("#vidsum_button").on('click', function() {
  var e=(window.screen.availHeight-200)/2,n=(window.screen.availWidth-650)/2;window.open(chrome.extension.getURL("http://127.0.0.1:8000"),"videosummarize","width=850,height=800,top="+e+",left="+n)
});
  ...
  $("body").on("contextmenu",function(e){
    ...
    return false;
 	...
 	$("#howto").click(function(){
 		chrome.tabs.create({'url':'https://khitk9738.github.io/Amadeus/index.htm'});
 	});
    ...
    if (error) {
        console.error(error);
         ...
         if(check === "false"){
			...
			chrome.browserAction.setIcon({path:"amadeus16.png"});
